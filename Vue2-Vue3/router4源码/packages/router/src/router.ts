...
import { applyToParams, assign, noop, isArray } from './utils'
...
export function createRouter(options: RouterOptions): Router {
  ...
  if (options.scrollBehavior && 'scrollRestoration' in history) {
  ...
  function finalizeNavigation(
    ...
    const state: Partial<HistoryState> | null = history.state
