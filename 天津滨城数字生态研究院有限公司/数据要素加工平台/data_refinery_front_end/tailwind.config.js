...
module.exports = {
  ...
  theme: {
    colors: {
      ...
      main: {
        DEFAULT: '#4CAAB4',//已配置到antd
        hover: {
          DEFAULT: '#358B94',
          border: '#70bcc2',
        },//已配置到antd
        focus: '#2D6F75',//已配置到antd
      },
      blue: {
        DEFAULT: '#4A83D6',
        hover: '#3964A4',
      ...
      red: {
        DEFAULT: '#FD4932',//已配置到antd
        hover: '#D45F6E',//已配置到antd
        focus: '#BA4A59'//已配置到antd
      },
      green: {
        DEFAULT: '#52C5A8',//已配置到antd
        hover: '#44A38B',//已配置到antd
        focus: '#3B9780'//已配置到antd
      },
      yellow: {
        DEFAULT: '#E4C140',
        hover: '#CAAB3B',
      ...
      orange: {
        DEFAULT: '#E57F3F',//已配置到antd
        hover: '#CA6D32',//已配置到antd
        focus: '#B5602B'//已配置到antd
      },
      black: {
