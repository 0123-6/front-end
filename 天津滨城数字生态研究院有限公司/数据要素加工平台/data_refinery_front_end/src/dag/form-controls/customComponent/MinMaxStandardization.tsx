      ...
      <div className="w-full flex flex-col"
        ...
        <div className="w-full mt-5 flex flex-col">
          ...
          <Select
            ...
            size="middle" mode="multiple" maxTagCount="responsive"
            options={options}/>
        </div>
        {/*最小值*/}
        <div className="w-full mt-4 flex items-center text-sm text-black-light">
          <span className="flex justify-end mr-3" style={{width:'56px'}}>{targetData.config[1].label}</span>
        ...
        {/*最大值*/}
        <div className="w-full mt-4 flex items-center text-sm text-black-light">
          <span className="flex justify-end mr-3" style={{width:'56px'}}>{targetData.config[2].label}</span>
          <InputNumber className="flex-1"
