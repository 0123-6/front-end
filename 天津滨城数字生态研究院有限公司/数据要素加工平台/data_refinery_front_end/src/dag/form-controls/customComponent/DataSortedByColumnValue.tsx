...
export const DataSortedByColumnValue = (_targetType, _targetData, _modelService, commandService) => () => {
		...
		<div className="w-full h-full flex flex-col bg-white">
			...
			<div className="w-full flex flex-col"
				...
				<div className="w-full mt-4 flex items-center text-sm text-black-light">
					...
					<Switch checked={targetData.config[1].value}
					        onChange={(value,_e) => change(value,1)} />
				</div>
			</div>
		</div>
	)
