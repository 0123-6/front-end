...
import {dataPreviewColumnsMap, dataResourceTypeToFileTypeMap} from "../../../../view/data-resource/static";
...
import ProcessingLine from "../../../../view/data-resource/my-data/components/ProcessingLine";
...
export default function OfficialDataCreate() {
	// state
	...
	return (
		...
		<div className={"w-full bg-white flex flex-col"}>
			...
			{/*内容区域*/}
			<div className={`flex-1 w-full pl-8 pr-8 pt-6 pb-[30px] flex flex-col rounded-lg ${number === 1 ? 'label-width-93' : 'label-width-97'}`}>
				<Form form={form}
					...
					<div className={"w-full flex-1 flex flex-col"}>
						...
						>
							<div className={"relative"} style={{width: '451px', minHeight: '18.2vh'}}>
								<Upload.Dragger
								...
								>
									<div className={"w-full h-[18.2vh] min-h-[130px] flex flex-col justify-center items-center text-sm leading-[14px]"}
									     style={{color: '#B7B7B7'}}>
					...
					{/*按钮*/}
					<div className={`mt-[6.66vh] mb-[4.35vh] w-full flex items-center`} style={{paddingLeft:'50px'}}>
						{
							number > 1 &&
