...
import UploadSvg from "../create/icon/UploadSvg.svg";
import UploadDisabledSvg from "../create/icon/UploadDisabledSvg.svg";
import {PlusOutlined} from "@ant-design/icons";
import Wenhao from "../../../icon/wenhao";
import {MarkdownEditor} from "../../../dag/components/MarkdownEditor";
import ImageEditorModal from "../create/components/ImageEditorModal";
import {get, post} from "../../../axios";
import DeleteSvg from "../../../icon/table/DeleteSvg";
import {uuidv4} from "@antv/xflow";
import { modelVersionList } from "../../../utils/static";
import {inputTypeList, outputTypeList} from "../create";
...
export default function MyModelDetailEdit(props: IProps) {
	// state
	...
	const clickEditOk = async () => {
		...
		const res = await post('/drapi/comp/mycomps', params)
	...
	return (
		//最外层
		<div className={"mt-[22px] w-full pl-[50px] pr-[50px] flex flex-col label-width-77 relative"}>
			<Form form={form}
				...
				<div className={"w-full flex flex-col"}>
					...
					{/*模型名称*/}
					<Form.Item
						style={{marginTop: modelFormat !== 'other' ? '44px': ''}}
						className={`label-height-38 `}
						label="模型名称"
						name="modelName"
						rules={[
