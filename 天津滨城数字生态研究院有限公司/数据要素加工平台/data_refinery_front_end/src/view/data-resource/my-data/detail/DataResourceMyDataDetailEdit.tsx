...
import {dataPreviewColumnsMap, dataPreviewDataMap} from "../../static";
...
export default function DataResourceMyDataDetailEdit(props: IProps) {
	// state
	...
	return (
		...
		<div className={"mt-6 w-full pl-[50px] pr-[50px] flex flex-col"}>
			...
			<div className={"flex justify-end items-center"}>
				<ButtonMain text={'保存'} click={clickEditOk} style={{width:'79px',height:'24px'}}/>
				<ButtonFifth text={'取消'} click={onCancel} style={{width:'79px',height:'24px'}} className={"ml-[11px]"}/>
			</div>
			{/*图片和名称等*/}
			<div className={"mt-[2.4vh] flex "}>
