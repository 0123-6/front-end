<template>
	<!--最外层-->
	<div class="w-full h-[290px] flex justify-center items-center">
		<!--项目准入，项目决策-->
		<div class="flex flex-col gap-y-[38px]">
			<!--项目准入-->
			<period-comp v-if="projectType === '全部' || projectType === '产业项目'"
			             size="large"
			             label="项目准入"
		...
		<img v-if="projectType === '全部'" src="./icon/LineTwoToOne.svg" alt="" class="select-none">
		<img v-else src="./icon/LineToRight.svg" alt="" class="select-none">
		<!--土地储备-->
		...
		></period-comp>
		<img v-if="projectType === '全部'" src="./icon/LineOneToTwo.svg" alt="" class="select-none">
		<img v-else src="./icon/LineToRight.svg" alt="" class="select-none">
		<!--绩效监管,运行维护-->
		<div class="flex flex-col gap-y-[38px]">
			<!--绩效监管-->
