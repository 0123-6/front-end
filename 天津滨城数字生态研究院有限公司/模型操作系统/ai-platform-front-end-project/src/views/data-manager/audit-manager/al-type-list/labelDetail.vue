 ...
 * @LastEditTime: 2022-09-20 13:30:49
...
-->
<template>
  <div class="common-dataSet-label-container">
    <ImageWithLabel
    ...
    <div class="label-studio-container">
      <div
        v-for="(item, index) in labelConfig"
        :key="index"
        class="label-container"
        :style="setStyle(item)"
      >
        <span class="label-type-container">{{ item.text }}</span>
        <span
...
.common-dataSet-label-container {
  width: 1200px;
  padding: 16px 0;
  margin: auto;
  .video-container {
