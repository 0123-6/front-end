<template>
  <div class="ee-view PolicyDetail">
    <el-breadcrumb class="ee-breadcrumb" separator="/">
      <el-breadcrumb-item :to="{ path: '/policy/list' }">政策管理</el-breadcrumb-item>
      <el-breadcrumb-item class="is-active">政策详情</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="ee-view__inner">
      <div class="ee-view__head d-flex ai-center jc-between">
        <div class="ee-view__title">政策详情</div>
...
export default {
  ...
  methods: {
    getDetail() {
      api
        .getOamPolicyDetail({ id: this.$route.params.id })
        .then(({ data }) => {
          if (data.code === 0) {
