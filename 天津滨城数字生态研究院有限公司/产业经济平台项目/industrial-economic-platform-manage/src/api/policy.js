...
export const getPolicyCompanyList = (params) => request({
  url: `/pythonApi/policy/match/company/${params.policy_id}`,
  method: 'get'
});
...
// oam政策列表
export const getOamPolicyList = (params) => request({
  url: '/pythonApi/oam/policy',
  method: 'get',
  params
});

// oam政策详情
export const getOamPolicyDetail = (params) => request({
  url: `/pythonApi/oam/policy/${params.id}`,
  method: 'get',
});
