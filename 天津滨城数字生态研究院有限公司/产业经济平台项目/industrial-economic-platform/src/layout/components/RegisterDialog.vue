<template>
  <el-dialog v-dialog-drag title="注册" width="480px" :modal-append-to-body="false" custom-class="register-dialog" visible :before-close="handleClose">
    <!--最外层-->
    <div class="tw-pt-[38px] tw-box-border tw-w-full tw-h-[563px] tw-bg-white tw-flex tw-flex-col">
      <el-form ref="registerForm" :model="form" :rules="rules" class="register-form" :inline="true" :close-on-click-modal="false">
        <!--姓名-->
        <el-form-item prop="nickname" label="姓名">
          <el-input v-model="form.nickname" type="nickname" prop="nickname" placeholder="请输入姓名" class="word" auto-complete="off" style="width: 318px;"></el-input>
        </el-form-item>
        <el-form-item prop="userPhoneNumber" label="手机号">
          <el-input v-model="form.userPhoneNumber" type="userPhoneNumber" prop="userPhoneNumber" placeholder="请输入手机号" class="word" auto-complete="off" style="width: 318px;"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="organization" label="企业/单位">
          <el-input v-model="form.organization" type="organization" prop="organization" placeholder="请输入企业/单位" class="word" auto-complete="off" style="width: 318px;"></el-input>
        </el-form-item>
        <!--机构验证码-->
        <el-form-item prop="tenantCode" label="机构验证码">
          <el-input v-model="form.tenantCode" type="tenantCode" prop="tenantCode" placeholder="请输入机构验证码" class="word" auto-complete="off" style="width: 318px;"></el-input>
        </el-form-item>
      </el-form>
      <el-button class="tw-mt-[1px] register-btn tw-ml-[101px]" :loading="loading" @click="handleRegister">注册</el-button>
